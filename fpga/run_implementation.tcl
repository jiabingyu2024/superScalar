...
proc assert_project_ip_config {script_dir project_dir cpu_mhz require_fresh_dcp} {
    ...
    if {$actual_irom_type ne "Dual_Port_ROM" ||
        ...
        error "Stale IROM_0 configuration: Memory_Type=$actual_irom_type Read_Width_B=$actual_irom_width_b Enable_B=$actual_irom_enable_b. Regenerate the dual-port ROM before implementation."
    }
