...
module CoreBranchPredictor (
    ...
    assign pred_return = pred_btb_hit && btb_return_q[pred_btb_idx] && ras_top_valid;
    ...
    always_comb begin
        pred_taken_o  = pred_return || (pred_direction_taken && pred_btb_hit);
        pred_valid_o  = pred_taken_o;
        pred_target_o = pred_return ? ras_top_pc :
                        pred_taken_o ? btb_target_q[pred_btb_idx] :
