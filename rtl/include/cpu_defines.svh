...
// Zbs reuses the existing three-bit M-operation field while EX_ZB is set.
`define ZBS_BSET        3'b000
`define ZBS_BCLR        3'b001
`define ZBS_BEXT        3'b010
`define ZBS_BINV        3'b011
