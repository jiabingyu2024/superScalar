...
// Zbkb reuses the existing three-bit M-operation field while EX_ZB is set.
`define ZBKB_PACK       3'b000
`define ZBKB_PACKH      3'b001
`define ZBKB_BREV8      3'b010
`define ZBKB_ZIP        3'b011
`define ZBKB_UNZIP      3'b100
