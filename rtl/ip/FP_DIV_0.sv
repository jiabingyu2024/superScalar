...
// Simulation model for the single-precision divide Floating-Point Operator IP.
module FP_DIV_0 (
    input  logic        aclk,
    input  logic        aresetn,
    ...
    import "DPI-C" function int unsigned rv32f_dpi_div(
    ...
    assign fire = s_axis_a_tvalid && s_axis_b_tvalid;
    ...
    always_ff @(posedge aclk) begin
        if (!aresetn) begin
            ...
            data_pipe[0]  <= rv32f_dpi_div(s_axis_a_tdata, s_axis_b_tdata);
            valid_pipe[0] <= fire;
