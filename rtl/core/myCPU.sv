...
`endif
    ...
    assign cache_cpu_req_uncached = cache_cpu_req_valid &&
                                    ((cache_cpu_req_addr < 32'h8010_0000) ||
                                     (cache_cpu_req_addr >= 32'h8014_0000));
    ...
    CoreDCache u_dcache (
        ...
        .cpu_req_uncached(cache_cpu_req_uncached),
