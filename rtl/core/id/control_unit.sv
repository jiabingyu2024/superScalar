    ...
    always_comb begin
        ...
        unique case (opcode)
            `OP_R_TYPE: begin
                ...
                o_m_op      = func3;
                if ((func7 == 7'b0000100) &&
                    ((func3 == 3'b100) || (func3 == 3'b111))) begin
                    o_inst_spec = `EX_ZB;
                    o_m_op = (func3 == 3'b100) ? `ZBKB_PACK : `ZBKB_PACKH;
                end else begin
                    unique case (func3)
            ...
            `OP_I_TYPE: begin
                ...
                o_is_rs2_imm = 1'b1;
                o_uses_rs1   = 1'b1;
                if ((func3 == 3'b101) && (i_instr[31:20] == 12'h687)) begin
                    o_inst_spec = `EX_ZB;
                    o_m_op      = `ZBKB_BREV8;
                end else if ((i_instr[31:20] == 12'h08f) &&
                             ((func3 == 3'b001) || (func3 == 3'b101))) begin
                    o_inst_spec = `EX_ZB;
                    o_m_op = (func3 == 3'b001) ? `ZBKB_ZIP : `ZBKB_UNZIP;
                end else begin
                    unique case (func3)
