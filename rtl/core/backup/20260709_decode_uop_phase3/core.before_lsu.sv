...
module core(
    ...
    assign fetch_req_valid = (&fetch_push_ready) && !debug.halt;
    ...
    always_comb begin
        dromAccess.exReadEn = 1'b0;
        dromAccess.exReadAddr = '0;
        dromAccess.storeWriteEn = 1'b0;
        dromAccess.storeWriteAddr = '0;
        dromAccess.storeWriteData = '0;
        dromAccess.storeWriteMask = '0;
